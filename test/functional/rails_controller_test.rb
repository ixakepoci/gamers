...
class RailsControllerTest < ActionController::TestCase
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post :create, rail: { authentication: @rail.authentication, g: @rail.g, nifty: @rail.nifty, user_id: @rail.user_id }
    end
  ...
  test "should update rail" do
    put :update, id: @rail, rail: { authentication: @rail.authentication, g: @rail.g, nifty: @rail.nifty, user_id: @rail.user_id }
    assert_redirected_to rail_path(assigns(:rail))
  end
